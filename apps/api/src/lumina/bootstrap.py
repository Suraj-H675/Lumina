...
from lumina.astronomy.api.relativity_visualizations_routes import (
    router as relativity_visualizations_router,
)
...
def create_app(settings: AppSettings) -> FastAPI:
    ...
    application.include_router(relativity_visualizations_router)
