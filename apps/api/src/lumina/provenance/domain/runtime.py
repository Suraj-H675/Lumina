...
CELESTRAK_PROVIDER_CODE: Final = "celestrak-gp"
CELESTRAK_ADAPTER_ID: Final = "celestrak-gp-selected-groups"
CELESTRAK_ADAPTER_VERSION: Final = "1"
CELESTRAK_CACHE_KEY: Final = "selected-satellites"
CELESTRAK_SOURCE_SCHEMA_VERSION: Final = "celestrak-omm-json-v1"
CELESTRAK_HOST: Final = "celestrak.org"
CELESTRAK_PATH: Final = "/NORAD/elements/gp.php"
CELESTRAK_FORMAT: Final = "json"
CELESTRAK_CONTENT_TYPE: Final = "application/json"
CELESTRAK_USER_AGENT: Final = "Lumina/0.0 Phase-4D provider-sync"
...
CELESTRAK_SUCCESS_REFRESH_INTERVAL: Final = timedelta(hours=2)
