...
def test_workflow_checkout_cache_and_tool_versions_are_fail_closed() -> None:
    workflow = WORKFLOW_PATH.read_text(encoding="utf-8")
    assert '"e9f0a1b2c3d4 (head)"' in workflow
    assert workflow.count(')" = "e9f0a1b2c3d4"') == 2
...
def test_migration_integrity_is_read_only_and_rejects_drift(tmp_path: Path) -> None:
    ...
    expected_contracts = [
        ...
        (
            "b8e5f1a2c3d4_correct_messier_target_semantics.py",
            "b8e5f1a2c3d4",
            "a7d4e9f2c1b3",
            "9152832c043502a6b28772751615759166bd55fab011a4c3fc6ef514a9e49bd7",
        ),
        (
            "c9f6a2b3d4e5_isolate_catalogue_operator_acl.py",
            "c9f6a2b3d4e5",
            "b8e5f1a2c3d4",
            "a67567004d1db2068fcf8b7c6919a9c863fd05ea3c859ded41927aa5924f5b63",
        ),
        (
            "d7e8f9a0b1c2_create_provider_runtime.py",
            "d7e8f9a0b1c2",
            "c9f6a2b3d4e5",
            "2c2fd5ad13133164484923280ac52868b0d7859cb4bb19baf5e6a67ed7db0e14",
        ),
        (
        ...
        (
            "f3a4b5c6d7e8_add_nasa_neows_provider.py",
            "f3a4b5c6d7e8",
            "e1f2a3b4c5d6",
        ...
        (
            "d8e9f0a1b2c3_create_identification_submission.py",
            "d8e9f0a1b2c3",
            "c6d7e8f9a0b1",
            "7bde95c23778ca584fa3c438d00fd9e01cb48439261803ebaeac520a2e44d107",
        ),
        (
            "e9f0a1b2c3d4_add_remote_identification_state.py",
            "e9f0a1b2c3d4",
            "d8e9f0a1b2c3",
            "e7f4a1cfb8b04442e0bd2a1541b9d92a789da41c1ed49d9e5aca86290404ae5c",
        ),
    ]
