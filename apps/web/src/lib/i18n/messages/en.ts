...
export const enMessages = {
  ...
  simulationLabs: {
    ...
    scaleExplorer: {
      ...
      comparisonEvidence: {
        inputNodeIds: "Input node IDs",
        inputSourceRecords: "Input source records",
        rounding: "Rounding: {rounding}",
        summary: "Algorithm: {algorithm} v{version}; output unit: {unit}.",
        title: "Comparison evidence",
      },
      controls: {
        description:
          "This control moves between {count} reviewed nodes in increasing characteristic-size order. There is no interpolation between the curated cases.",
        nodeSummary: "Node {index} of {count}: {node}",
        sliderAriaValue: "{index} of {count}: {node}",
        sliderLabel: "Curated scale position",
        title: "Choose a scale node",
      },
      dataAlternative: {
        description:
          "This table represents the same model state without relying on the visual track. Every row keeps its source unit, characteristic quantity, comparison, and model position.",
        title: "Text and data alternative",
      },
      entityLinks: {
        description:
      ...
      invalidMetadataDescription: "A safe fallback for an invalid Scale Explorer share state.",
      ...
      metadataTitle: "Scale Explorer",
      model: {
        assumptions: "Assumptions",
        automatedValidationFixtures: "Automated validation fixtures: {fixtures}.",
        characteristicSizeAlgorithm: "Characteristic-size algorithm",
        characteristicSizeInputs: "Characteristic-size inputs",
        characteristicSizeTolerance: "Characteristic-size tolerance",
        characteristicSizeValidDomain: "Characteristic-size valid domain",
        comparisonAlgorithm: "Comparison algorithm",
        comparisonInputs: "Comparison inputs",
        contentReview: "Content review",
        contentReviewValue: "{status}; version {version}; reviewed by {reviewers} on {reviewedAt}.",
        derivedQuantityContracts: "Derived quantity contracts",
        disclaimer:
          "This is an educational model, not an operational, research-grade, navigation, or measurement system.",
        howScaleBuilt: "How the scale is built",
        input: "Input",
        inputValue: "{name}: one of the curated node IDs; unit is {unit}.",
        knownLimitations: "Known limitations",
        mathsToNotice: "Maths to notice",
        modelVersion: "Model version",
        numericalTolerance: "Numerical tolerance",
        output: "Output",
        references: "References",
        relationshipsUsed: "Relationships used",
        shareStateShape: "Share state shape",
        shareStateSuffix: "only those three fields are accepted, with no unknown fields.",
        title: "Model and assumptions",
        validDomain: "Valid domain",
        validRange: "Valid range",
        validRangeValue:
          "Exactly {count} discrete IDs: {nodes}. Unknown IDs and in-between values are rejected; there is no interpolation.",
      },
      noScript: {
        dataDescription:
          "Same curated nodes, ordered by characteristic size. Each row includes its characteristic quantity and normalized logarithmic display position. The log coordinate is dimensionless, not a physical location.",
        dataTitle: "Text and data alternative",
        invalidDescription:
          "Earth is shown as the safe default because the requested version, node, field set, or serialized form was not accepted.",
        intro: "Compare cited astronomical sizes without JavaScript.",
        model: {
          assumptions: "Assumptions:",
          knownLimitations: "Known limitations:",
          model: "Model:",
        ...
        selectedSummary: "{displayValue} {quantity}",
        sourceSummary:
          "Source: {sourceValue} {sourceUnit} ({sourceQuantity}); status: {status}; display: {position}% logarithmic.",
        tableCaption:
          "Scale nodes, characteristic and source quantities, normalized display positions, status, and evidence.",
        tableHeaders: {
          characteristicSize: "Characteristic size",
        ...
        tableSourceEvidence: "Characteristic: {characteristic}; transition: {transition}",
        tableStatus: "{status}; normalized logarithmic display position: {position}",
      },
      objective: {
      ...
      quantities: {
        ...
        observableExtent: "observable-universe extent",
        width: "characteristic width",
      },
      result: {
        calculatedComparison:
          "Calculated from {selected} and {reference} characteristic sizes. The ratio is dimensionless; the displayed sentence is rounded to two significant figures.",
        category: "Category",
        characteristicEvidence: "Characteristic value evidence",
        comparison: "Comparison",
        displayPosition: "Display position",
        displayPositionValue: "approximately {percent}% of this curated track",
        readingTitle: "Reading this result",
        referenceFallback: "the reference node",
      ...
      share: {
        copied: "Share link copied. It contains only the model version and selected node.",
        description:
          "The reproducible state contains model version {modelVersion}, schema version {schemaVersion}, and the selected node ID. It does not save an account, location, or personal data.",
        label: "Share link",
        ready: "Share link ready below. Copy it manually; no personal data is included.",
        reset: "Scale Explorer reset to Earth.",
        title: "Share this scale position",
      },
      sourceQuantities: {
      ...
      sources: {
        ...
        details: "({authors}; {claimScope}; retrieved {retrievedAt}; data date: {dataDate})",
        education: "Education source",
        metadata: "Dataset/release: {dataset}; record/reference: {record}; terms/licence: {terms}",
        unavailable: "Source record unavailable for {sourceId}.",
        unavailableReference: "Unavailable source record: {sourceId}",
        unavailableShort: "Unavailable: {sourceId}",
      },
      statuses: {
        approximate: "Approximate",
        derivedApproximate: "Derived approximate value",
        modelBased: "Model-based estimate",
        reported: "Reported source value",
      },
      table: {
        caption:
          "All curated Scale Explorer nodes in increasing characteristic-size order. Select a row to move the model to that node.",
        ...
        onTrack: "approximately {percent}% on track",
        selected: "Selected",
        transitionExplanation: "Transition explanation",
      },
      track: {
        coordinate: "Display coordinate: 0–100% (normalized, dimensionless)",
        description:
          "The markers show relative position on a base-10 logarithmic display from the smallest to the largest curated characteristic size. The track is a diagram, not a physical arrangement and not a distance scale.",
        largest: "Largest curated node",
        legendAriaLabel: "Relative scale track legend",
        markerSummary:
          "Selected marker: {node}. Marker spacing is logarithmic; markers are not physical positions.",
        otherMarker: "Other curated node marker",
        selectedMarker: "Selected node marker",
        smallest: "Smallest curated node",
        title: "Relative scale track",
      },
      transitionContract: {
        algorithm: "Algorithm",
        generated: "Generated",
        inputNodeIds: "Input node IDs",
        inputSourceRecords: "Input source records",
        learnerFacingRounding: "Learner-facing rounding",
        numericalTolerance: "Numerical tolerance",
        testReferences: "Test references",
        title: "Transition calculation contract",
        units: "Units",
        unitsValue: "inputs: {input}; output: {output}",
        validDomain: "Valid domain",
      },
    },
    spectroscopyLab: {
