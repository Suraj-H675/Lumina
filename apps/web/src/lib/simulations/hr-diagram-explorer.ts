...
const SOURCE_METADATA: Readonly<Record<string, Readonly<Record<string, string>>>> = {
  "gaia-dr3-main-source-catalogue": {
    ...
    record_reference:
      "Gaia DR3 archive data model section 20.1.1; source identity, G photometry, BP-RP, parallax, and parallax_error fields.",
    ...
    claim_scope:
      "Definitions and units for the Gaia DR3 source identity, G-band magnitude, BP-RP colour, parallax, and parallax uncertainty fields used in the curated records.",
  ...
  "gaia-dr3-astrophysical-parameters": {
    ...
    record_reference:
      "Gaia DR3 archive data model section 20.2.1; GSP-Phot Teff and M_G percentiles, FLAME luminosity/stage, ESP-HS spectral tags/flags.",
    retrieved_at: "2026-09-09",
    ...
    claim_scope:
      "Field semantics, p16/p50/p84 uncertainty interpretation, spectral-quality flag digits, and FLAME evolutionary-stage landmarks for the source-published quantities used by this artifact.",
    source_type: "official-agency",
  },
  ...
  "hunt-reffert-2024-vizier-members": {
    ...
    record_reference:
      "VizieR members table J/A+A/686/A42/members; GaiaDR3 is the join key, with ID, inrj, inrt, and Prob retained.",
    retrieved_at: "2026-09-09",
  ...
  "esa-gaia-hr-diagram": {
    ...
    record_reference:
      "Page-level educational explanation of the conventional hotter/bluer-left, cooler/redder-right and brighter-upward H-R orientation.",
    retrieved_at: "2026-09-09",
