...
export const IMPACT_SIMULATOR_DIAMETER_2000_RESULT = {
  model_version: "impact-simulator-v1",
  schema_version: 1,
  inputs: {
    diameter_m: 2000.0,
  ...
  target_density_kg_m3: 2500.0,
  impactor_mass_kg: 12566370614359.172,
  kinetic_energy_j: 1.8158405537749003e21,
  tnt_equivalent_megatons: 434411.61573562206,
  best_estimate_crater: {
    scaling_coefficient: 1.161,
    transient_diameter_m: 18158.837527069052,
    final_diameter_m: 26624.76927891178,
    classification: "complex",
  },
  coefficient_sensitivity: [
    {
      scaling_coefficient: 0.8,
      transient_diameter_m: 12512.549544922691,
      final_diameter_m: 17479.022041110777,
      classification: "complex",
    },
    {
      scaling_coefficient: 1.161,
    ...
    {
      scaling_coefficient: 1.5,
      transient_diameter_m: 23461.030396730042,
      final_diameter_m: 35563.833427355545,
      classification: "complex",
    },
  ],
  ejecta_thickness_radii: [
    {
      thickness_m: 100.0,
      radius_m: 21332.645492439096,
    },
    {
      thickness_m: 10.0,
      radius_m: 45959.79147906308,
    },
    {
      thickness_m: 1.0,
      radius_m: 99017.36910912528,
    },
    {
      thickness_m: 0.1,
      radius_m: 213326.4549243909,
    },
  ],
  uncertainty_note:
    "The low/high crater values vary only the published Eq. 21 scaling coefficient from 0.8 to 1.5. They are a coefficient-sensitivity range, not a complete statistical confidence interval or full geological uncertainty estimate.",
