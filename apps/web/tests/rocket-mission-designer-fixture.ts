...
} as RocketMissionDesignerCalculationResponse;

/* Python-produced alternate state: payload changed from 5000 kg to 6000 kg. */
  ...
  stages: [
    {
      ...
      specific_impulse_s: 300.0,
      thrust_n: 7000000.0,
      ignition_mass_kg: 484000.0,
      burnout_before_jettison_mass_kg: 84000.0,
      mass_ratio: 5.761904761904762,
      effective_exhaust_velocity_m_s: 2941.995,
      ideal_delta_v_m_s: 5152.222017022762,
      surface_gravity_thrust_to_weight: 1.4757969303423848,
      stage_dry_fraction: 0.06976744186046512,
      stage_propellant_fraction: 0.9302325581395349,
    },
    {
      ...
      specific_impulse_s: 350.0,
      thrust_n: 1000000.0,
      ignition_mass_kg: 54000.0,
      burnout_before_jettison_mass_kg: 14000.0,
      mass_ratio: 3.857142857142857,
      effective_exhaust_velocity_m_s: 3432.3275,
      ideal_delta_v_m_s: 4633.3905935688235,
      surface_gravity_thrust_to_weight: 1.8896447467876039,
      stage_dry_fraction: 0.16666666666666666,
      stage_propellant_fraction: 0.8333333333333334,
    },
  ],
  total_ideal_delta_v_m_s: 9785.612610591586,
  mass_fractions: {
    launch_mass_kg: 484000.0,
    total_stage_dry_mass_kg: 38000.0,
    total_propellant_mass_kg: 440000.0,
    payload_mass_kg: 6000.0,
    stage_dry_fraction_of_launch_mass: 0.07851239669421488,
    propellant_fraction_of_launch_mass: 0.9090909090909091,
    payload_fraction_of_launch_mass: 0.012396694214876033,
  },
  payload_tradeoff: [
    {
      payload_multiplier: 0.0,
    ...
    },
    {
      ...
      total_ideal_delta_v_m_s: 10505.874545973013,
    },
    {
      payload_multiplier: 1.0,
      payload_mass_kg: 6000.0,
    ...
    },
    {
      ...
      total_ideal_delta_v_m_s: 9219.722729574452,
    },
    {
      payload_multiplier: 2.0,
      payload_mass_kg: 12000.0,
      total_ideal_delta_v_m_s: 8756.289307773193,
    },
  ],
  reference_comparison: {
    reference_id: "earth_200_mile_orbit_example",
    ...
    label: "NASA Glenn approximate 200-mile circular-orbit velocity-change example",
    reference_value_m_s: 7620.0,
    ideal_delta_v_difference_m_s: 2165.6126105915864,
    ideal_delta_v_to_reference_ratio: 1.2842011299988958,
    interpretation:
      "This is an educational velocity-reference comparison only. It is not a mission delta-v requirement, feasibility result, launch capability claim, or operational planning output.",
  },
  model_note:
