...
ensure_database() {
  ...
  run_sql -c "GRANT CONNECT ON DATABASE $database TO lumina_admin, $migration_role, $runtime_role"
...
ensure_database lumina lumina_migrate lumina_app
ensure_database lumina_test lumina_test_migrate lumina_test_app
