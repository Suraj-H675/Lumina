...
EXPECTED_MIGRATIONS = (
    ...
    MigrationContract(
        filename="e8f4c1a9b362_add_explainable_catalog_search.py",
    ...
    MigrationContract(
        filename="9c7e4a1d2f6b_seed_messier_catalogue.py",
        revision="9c7e4a1d2f6b",
        down_revision="f2a6c8d9e0b1",
        sha256="bb3b081aa10dd64d46e2d5e3cba4dd06247e1193eeacca354cc2e9c958b50b40",
    ),
    MigrationContract(
        filename="a7d4e9f2c1b3_grant_messier_canonical_selection_dml.py",
    ...
    MigrationContract(
        filename="b5c6d7e8f9a0_add_launch_library_provider.py",
    ...
    MigrationContract(
        filename="d8e9f0a1b2c3_create_identification_submission.py",
        revision="d8e9f0a1b2c3",
        down_revision="c6d7e8f9a0b1",
        sha256="7bde95c23778ca584fa3c438d00fd9e01cb48439261803ebaeac520a2e44d107",
    ),
    MigrationContract(
        filename="e9f0a1b2c3d4_add_remote_identification_state.py",
    ...
    MigrationContract(
        filename="f1b2c3d4e5f6_add_identification_provider_conditions.py",
